...
import {FaHome, FaShoppingCart, FaUser, FaEnvelope, FaFacebookSquare, FaSlack, FaPhoneAlt} from 'react-icons/fa'
    ...
    <BrowserRouter>
      <div className="grid-container">
        ...
        <strong>Contact Us : </strong><br />
          <FaEnvelope size={20} style={{ fill: 'black' }}/>&nbsp;&nbsp;yourchoice@gmail.com&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <FaPhoneAlt size={20} style={{ fill: 'black' }}/>+(91) 9898989898
        </footer>
      </div>
    </BrowserRouter>
  );
